...
| Trained Qwen3-4B SFT + P3 GRPO on A100 SXM4-80GB (Day 1 on-site) | **n=5 mean composite reward 0.305** | `data/audit_grpo_p3_F_n5.json` |
| SFT-only baseline (pre-GRPO) | 0.280 | `data/audit_F_n5.json` |
