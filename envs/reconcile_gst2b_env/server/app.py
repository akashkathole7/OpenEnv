...
"""
FastAPI application for the Reconcile Gst2b Env Environment.

This module creates an HTTP server that exposes the ReconcileGST2BEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m reconcile_gst2b_env.server.app
    ...
    multiple workers:
        uvicorn reconcile_gst2b_env.server.app:app --workers 4
    """
    import uvicorn
